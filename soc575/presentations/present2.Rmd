...
100 * (exp(coef(ordinalBasicBase)) - 1)
tab_model(ordinalBasicBase)
```
...
100 * (exp(coef(ordinalBasicBaseWide)) - 1)
tab_model(ordinalBasicBaseWide)
```
...
100 * (exp(coef(ordinalControlsBase)) - 1)
tab_model(ordinalControlsBase)
```
...
100 * (exp(coef(ordinalBasicFollow)) - 1)
tab_model(ordinalBasicFollow)
```
...
100 * (exp(coef(ordinalBasicFollowWide)) - 1)
tab_model(ordinalBasicFollowWide)
```
...
100 * (exp(coef(ordinalControlsFollow)) - 1)
tab_model(ordinalControlsFollow)
```
