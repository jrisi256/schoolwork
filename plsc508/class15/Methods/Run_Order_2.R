# THIS IS MAINLY DATA PREPROCESSING, NO SIMULATION DONE HERE
# JUST RUN TO GET YOUR DATA INTO CORRECT SHAPE
...
#####################################################
load(here("class15", "Methods", "CoppockJEPS_10000randomizations.rdata"))
...
nmhouse2008 <-read.csv(here("class15", "Methods", "CoppockJEPS_rollcalldata.csv"))
...
### Bring in shapefile
NM_geo <-rgdal::readOGR(here("class15", "Methods", "CoppockJEPSshapefile", "hd_court_ordered.shp"))
